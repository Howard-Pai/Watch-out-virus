...
public class GamePage extends JPanel{
	...
	static {
		try {
			background = ImageIO.read(new File("/Users/jeter0902/eclipse-workspace/Watch_Out_Virus_2/taipei-1851948_1920.jpg"));
			life = ImageIO.read(new File("/Users/jeter0902/eclipse-workspace/Watch_Out_Virus_2/heart.png"));
			character1 = ImageIO.read(new File("/Users/jeter0902/eclipse-workspace/Watch_Out_Virus_2/Tedros.png"));
			character2 = ImageIO.read(new File("/Users/jeter0902/eclipse-workspace/Watch_Out_Virus_2/Trump.png"));
			character3 = ImageIO.read(new File("/Users/jeter0902/eclipse-workspace/Watch_Out_Virus_2/ShiJong.png"));
			character4 = ImageIO.read(new File("/Users/jeter0902/eclipse-workspace/Watch_Out_Virus_2/Tzuyu.png"));
			bullet = ImageIO.read(new File("/Users/jeter0902/eclipse-workspace/Watch_Out_Virus_2/bullet.png"));
			virus1 = ImageIO.read(new File("/Users/jeter0902/eclipse-workspace/Watch_Out_Virus_2/virus1.png"));
			virus2 = ImageIO.read(new File("/Users/jeter0902/eclipse-workspace/Watch_Out_Virus_2/virus2.png"));
			virus3 = ImageIO.read(new File("/Users/jeter0902/eclipse-workspace/Watch_Out_Virus_2/virus3.png"));
			health = ImageIO.read(new File("/Users/jeter0902/eclipse-workspace/Watch_Out_Virus_2/healthcare-and-medical.png"));
			vaccine = ImageIO.read(new File("/Users/jeter0902/eclipse-workspace/Watch_Out_Virus_2/vaccination.png"));
		}catch(Exception e) {
			e.printStackTrace();
		}
	}
	...
	public GamePage(JFrame f, ItemPage itemPage, CharacterPage charPage) {
		this.f = f;
